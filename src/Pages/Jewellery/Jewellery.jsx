...
import Bulaq from "../../assets/images/Jewellery/Bhulaq.png";
import Byhung from "../../assets/images/Jewellery/Byhung.png"
function Jewellery() {
    return (
        <div className={"jewellery-container"}>
            ...
            <div className={"jewellery-list"}>
                ...
                <Card heading={"Hansuli"} description={""} link={"/hansuli"}
                      img={"https://images.herzindagi.info/image/2019/Oct/hansuli-are-still-a-big-fashion-statement-inside-three.jpg"}
                      imgDescription={"Hansuli Image"}/>

                <Card heading={"Nathuli"} description={""} link={"/nathuli"}
                      img={"https://joshimilestoner.com/wp-content/uploads/2023/09/NATH-KUMAONI.webp"}
                      imgDescription={"Nathuli Image"}/>

                <Card heading={"Bulaq"}
                      description={"Bulaq is an exquisite jewellery which i sworn at the nasal septim"} link={"/bulaq"}
                      img={Bulaq} imgDescription={"Bulaq Image"}/>

                <Card heading={"Kaanphool"} description={""} link={"/kaanphool"} img={""}
                      imgDescription={"Kaanphool Image"}/>
                ...
                <Card heading={"Jajeer"} description={""} link={"/jajeer"}
                      img={"https://museumofmaterialmemory.com/wp-content/uploads/2020/03/IMG_4513.jpg"}
                      imgDescription={" Jajeer Image"}/>

                <Card heading={"Chareu"} description={""} link={""} img={""} imgDescription={"Chareu Image"}/>
                ...
                <Card heading={"Pach Ladi"} description={""} link={"/thuauk"} img={"https://cdn.shopify.com/s/files/1/0102/3757/5264/files/IMG_1404_copy_large.JPG?v=1563723657"} imgDescription={"Thuauk Image"}/>

                <Card heading={"Dhagul"} description={""} link={"/thuauk"} img={"https://cdn.shopify.com/s/files/1/0102/3757/5264/files/IMG_8807_large.JPG?v=1563723458"} imgDescription={"Thuauk Image"}/>
                ...
                <Card heading={"Munedi"} description={"Ring"} link={"/munedi"} img={""} imgDescription={"Munedi Image"}/>
