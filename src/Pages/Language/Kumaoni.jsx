    ...
    return (
        <div className={"kumaoni-language-container"}>
            ...
            <div className={"kumaoni-language-table-container"}>
                ...
                <div>
                   <p>Note: एक ही दिन में कहीं जाकर लौटने पर : दिसौड़ी Returning on same day on a journey: Disaudi

                        यदि आप कहीं जाकर एक ही दिन (उसी दिन ) में लौट आते हैं, तो आप दिसौड़ीवहां गए थे ।

                        If you go somewhere and return the same day, you had gone to the place ‘disaudi’.

                        2.कहीं जाकर यदि रात में ठहरने का कार्यक्रम हो:बास्स

                        If you go somewhere and return the next day: Baassa

                        यदि आप किसी रिश्तेदार के यहाँ जाकर अगले दिन लौटते हैं तो आप बास्स वहां गए थे।

                        If you go somewhere and return the next day, you had gone to the place ‘baassa’.
                    </p>
                </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Up/Above</td>
                        <td>ऊपर</td>
                        <td>मल्ल / मल्ली (malla/malli)</td>
                    </tr>

                    <tr>
                        <td>Onto</td>
                        <td>ऊपर</td>
                        <td>मथ में (math mein)</td>
                    </tr>

                    <tr>
                        <td>Below</td>
                        <td>नीचे</td>
                        <td>तल्ल / तल्ली (talla/talli)</td>
                    </tr>
                    ...
                    <tr>
                        <td>Place of God/ Temple</td>
                        <td>देव स्थान / मंदिर</td>
                        <td>देबता थान (debta than)</td>
                    </tr>
                </tbody>
                </table>

                <div><p>GROUND FLOOR or BASEMENT: गोठ(Goth)

                    CATTLE HOUSE: गोरुक गोठ (Goruk Goth)

                    ON UPPER FLOOR: पाण में (Pann mein): Generally old houses used to be two storey buildings. So if you are on first floor, then call the ground floor as ‘Goth’ and if you are in Goth you call the first floor as ‘Pann’.

                    पुराने मकान साधारणतया दो से तीन मंजिला हुआ करते थे, इसलिए यदि आप ऊपर वाली मंजिल में हैं, तो सबसे नीचे वाली मंजिल को ‘गोठ’ कहेंगे । और यदि आप गोठ यानि कि सबसे नीचे वाले हिस्से में हैं तो ऊपर वाली हर मंजिल को ‘पाण’ कहेंगे ।

                    STORAGE PLACE ON ATTIC: भाड़ (Bhadd ) :The place is not as large as can be called attic, but similar in old traditional houses of the region. It is rather smaller compared to an attic and used for storing firewood etc.
                ...
                <p className={"table-caption"}>Family Relations रिश्तेदारी-नाते</p>
                <table className={"kumaoni-language-table"}>
                    {/*<caption>Family Relations रिश्तेदारी-नाते</caption>*/}
                    ...
                    <tr>
                        <td>Father</td>
                        <td>पिता</td>
                        <td>बाजू (Baju)/बबा (Ba-baa)</td>
                    </tr>

                    <tr>
                        <td>Elder Brother</td>
                        <td>बड़ा भाई</td>
                        <td>ददा (Da-Daa)/ दा(Daa)</td>
                    </tr>
                    ...
                    <tr>
                        <td>Paternal Uncle (father’s younger brother)</td>
                        <td>चाचा</td>
                        <td>काका/ का (Kaka/ Ka)</td>
                    </tr>
                    <tr>
                        <td>Paternal Uncle’s (father’s younger brother’s)wife</td>
                        <td>चाची</td>
                        <td>काखी (Kakhi)</td>
                    </tr>
                    <tr>
                        <td>Paternal Uncle (father’s elder brother)</td>
                        <td>ताऊ</td>
                        <td>ठुल बाजू/बा (Thul Baju/Ba)</td>
                    </tr>
                    <tr>
                        <td>Paternal Uncle’s (father’s elder brother’s)wife</td>
                        <td>ताई</td>
                        <td>ठुल इजा (Thul Ija)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>माजू (Ma ju /Mai-ju)</td>
                        <td>मामी</td>
                    </tr>
                    <tr>
                        <td>Maternal Aunt (mother’s younger sister)</td>
                        <td>मौसी</td>
                        <td>कैंजा (Kainja)</td>
                    </tr>
                    <tr>
                        <td>Maternal Aunt’s (mother’s younger sister) Husband</td>
                        <td>मौसा</td>
                        <td>काका (Kaka)</td>
                    </tr>
                    <tr>
                        <td>Maternal Aunt (mother’s elder sister)</td>
                        <td>ताई ( माँ की बहन )</td>
                        <td>जड़जा (Jadja)</td>
                    </tr>
                    <tr>
                        <td>Maternal Aunt’s (mother’s elder sister) Husband</td>
                        <td>ताऊ (माँ की बहन के पति)</td>
                        <td>ठुल बाजू/ ठुल बा
                    ...
                    <tr>
                        <td>Husband of Father’s sister</td>
                        <td>फूफा</td>
                        <td>भिना /भिनजू (Bhina/ Bhinju)
                    ...
                    <tr>
                        <td>Wife’s elder sister</td>
                        <td>पत्नी की बड़ी बहन</td>
                        <td>ज्येठ सासु (Jye-tha Saasu)</td>
                    </tr>
                    <tr>
                        <td>Wife’s elder brother</td>
                        <td>पत्नी का बड़ा भाई</td>
                        <td>ज्येठु (Jyethu)</td>
                    </tr>
                    <tr>
                        <td>Husband’s elder sister</td>
                        <td>पति की बड़ी बहन</td>
                        <td>नन्द सासु (Nanda Saasu)</td>
                    </tr>
                    <tr>
                        <td>Husband’s elder brother</td>
                        <td>पति का बड़ा भाई</td>
                        <td>ज्येठ/ जेठ (Jye-th)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Husband’s elder brother’s wife</td>
                        <td>ज्येठानी</td>
                        <td>जेठानी (Jethani)</td>
                    </tr>
                    <tr>
                        <td>Husband’s younger brother’s wife</td>
                        <td>देवरानी</td>
                        <td>द्योरानी (Dyorani)</td>
                    </tr>
                    <tr>
                        <td>Baby</td>
                        <td>छोटा बच्चा</td>
                ...
                <div>
                    <p>Note: एत्थ- उत्त्थ: ये शब्द यहाँ-वहां/ जहाँ-तहां के लिए प्रयोग होता है|

                        You can use ettha-uttha in following way:

                        उएत्थ उत्थ फेरी रूंछ| (oo ettha-uttha feri roonchha.)

                        वह जहाँ तहाँ घूमता है | He roams here and there. </p>
               </div>
            </div>
